import { C as CredentialsProviderError, j as setCredentialFeature, n as chain, m as getProfileName } from "./main-ZlvUAe55.js";
...
const resolveCredentialSource = (credentialSource, profileName, logger) => {
  const sourceProvidersMap = {
    EcsContainer: async (options) => {
      ...
      const { fromContainerMetadata } = await import("./index-11gPrHJQ.js");
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}, resolveProfileData2) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await import("./index-DZTJY7Sf.js");
...
const resolveProcessCredentials = async (options, profile) => import("./index-BlKKujJW.js").then(({ fromProcess }) => fromProcess({
  ...options,
  profile
...
const resolveWebIdentityCredentials = async (profile, options) => import("./index-axU6dnWA.js").then(({ fromTokenFile }) => fromTokenFile({
