...
const remoteProvider = async (init) => {
  var _a2, _b;
  const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await import("./index-CSFOEkOR.js");
...
const inferPhysicalRegion = async () => {
  ...
  if (!process.env[ENV_IMDS_DISABLED]) {
    try {
      const { getInstanceMetadataEndpoint, httpRequest } = await import("./index-CSFOEkOR.js");
