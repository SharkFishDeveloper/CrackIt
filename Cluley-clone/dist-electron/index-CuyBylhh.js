...
import { aA as ProviderError, aB as IniSectionType, aC as CONFIG_PREFIX_SEPARATOR, aD as slurpFile, aE as getConfigFilepath, aF as parseIni, m as getProfileName, C as CredentialsProviderError, j as setCredentialFeature } from "./main-ZlvUAe55.js";
import { promises } from "fs";
import { g as getSSOTokenFilepath, a as getSSOTokenFromFile } from "./getSSOTokenFromFile-DhGH1trc.js";
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
  var _a;
  const { SSOOIDCClient } = await import("./index-D614JFvh.js");
  const coalesce = (prop) => {
    var _a2, _b;
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
  const { CreateTokenCommand } = await import("./index-D614JFvh.js");
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger }) => {
  ...
  const { SSOClient, GetRoleCredentialsCommand } = await import("./loadSso-Dd6UNs5I.js");
