...
import { C as CredentialsProviderError, j as setCredentialFeature } from "./main-ZlvUAe55.js";
const fromWebToken = (init) => async (awsIdentityProperties) => {
  ...
  if (!roleAssumerWithWebIdentity) {
    const { getDefaultRoleAssumerWithWebIdentity } = await import("./index-DZTJY7Sf.js");
